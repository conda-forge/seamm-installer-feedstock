...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/seamm-installer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12768&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/seamm-installer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `seamm-installer` can be installed with:

```
conda install seamm-installer
```

It is possible to list all of the versions of `seamm-installer` available on your platform with:
